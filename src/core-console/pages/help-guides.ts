...
export const platformHelpGuides: HelpGuide[] = [
  ...
  {
    title: "Nechat aplikaci nahlásit dostupnou aktualizaci",
    summary: "Postup pro vývoj nebo provoz, kdy běžící aplikace potřebuje Core upozornit na novější manifest nebo UI artefakt.",
    outcome: "Core uloží update signal, admin jej uvidí v Apps managementu a může rozhodnout o refreshi artefaktu.",
    category: "Aplikace",
    path: "/core/apps/installed",
    source: "Hekatoncheiros",
    actionLabel: "Otevřít instalované aplikace",
    ...
    steps: [
      "Otevři Apps / Installed apps.",
      "Najdi nainstalovanou aplikaci a klikni na Issue token.",
      "Zkopíruj krátkodobý app token do běžící aplikace nebo vývojového skriptu.",
      "Z aplikace zavolej POST /api/v1/apps/installed/update-signal s Bearer tokenem.",
      "V Apps / Installed apps ověř, že se u aplikace objevil update signal.",
      "Po ověření použij Refresh artifact, nebo signál smaž přes Clear signal.",
    ],
  },
  {
